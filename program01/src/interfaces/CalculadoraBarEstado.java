...
public class CalculadoraBarEstado extends JFrame implements ActionListener{
...
//	private JMenuItem item_dividir;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CalculadoraBarEstado frame = new CalculadoraBarEstado();
	...
	public CalculadoraBarEstado() {
		...
		btool_nuevo.setIcon(new ImageIcon(CalculadoraBarEstado.class.getResource("/iconos/nuevo.gif")));
		tool.add(btool_nuevo);
		btool_nuevo.addActionListener(this);
		
		btool_salir = new JButton("");
		btool_salir.setIcon(new ImageIcon(CalculadoraBarEstado.class.getResource("/iconos/salir.gif")));
		...
		contentPane.add(panel_estado, BorderLayout.SOUTH);
		panel_estado.setLayout(new BorderLayout(0, 0));
		
		label_estado = new JLabel("Estado: ");
		label_estado.setFont(new Font("Tahoma", Font.ITALIC, 10));
		panel_estado.add(label_estado, BorderLayout.WEST);
		
		label_listo = new JLabel("listo");
		label_listo.setFont(new Font("Tahoma", Font.ITALIC, 10));
		panel_estado.add(label_listo);
